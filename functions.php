<?php
/**
 * aeris functions and definitions
 *
...
if ( ! function_exists( 'theme_aeris_setup' ) ) :
/**
 ...
 */
function theme_aeris_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on aeris, use a find and replace
	 * to change 'theme-aeris' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'theme-aeris', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'theme-aeris' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'theme_aeris_custom_background_args', array(
 ...
 */
function theme_aeris_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'theme_aeris_content_width', 640 );
}
add_action( 'after_setup_theme', 'theme_aeris_content_width', 0 );
 ...
 */
function theme_aeris_widgets_init() {
...
add_action( 'widgets_init', 'theme_aeris_widgets_init' );
...
function theme_aeris_scripts() {
	...
	wp_enqueue_script( 'theme-aeris-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
